...
export default class SignUp {
    ...
    async renderPage() {
        ...
        const signFormContainer = new SignFormContainer(signFormElement, this.signupConfig.inputs);
        ...
        const buttonSign = new ButtonSign(signFormElement, this.signupConfig.signButton);
        buttonSign.render();
    ...
    static #addEventListeners() {
        document.querySelector('.button-sign').addEventListener('click', async (e) => {
            ...
            } else if (!Validator.validateRepeatPasswords(data[1].value, data[2].value)) {
